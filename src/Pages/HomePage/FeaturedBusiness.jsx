...
export const FeaturedBusiness = () => {
  ...
  return (
    <div className="flex w-full justify-center mt-[100px]">
      <div className="flex flex-col gap-8 md:gap-12 w-[88%] justify-center">
        <div className="flex flex-row justify-between items-center gap-4 w-full">
          <h1 className="text-[#031D3D] font-semibold text-[18px] md:text-[26px]">
            Featured Business
          </h1>
          <button className="w-fit cursor-pointer rounded-3xl px-4 py-2 items-center flex flex-row gap-3 border border-[#099137] text-[#099137]">
            <span className="text-[14px] font-normal md:text-[15px]">
              See all
            </span>
